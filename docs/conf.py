...
MOCK_MODULES = ['torch', 'torch.utils', 'torch.nn', 'torch.optim', 'torch.utils.data', 'torch.utils.data.sampler',
                ...
                'torchvision',
                'tqdm']
sys.modules.update((mod_name, Mock(class_that_is_extended=object)) for mod_name in MOCK_MODULES)

# -- Project information -----------------------------------------------------

project = 'pylissom'
copyright = '2018, Hernan Barijhoff'
author = 'Hernan Barijhoff'
...
latex_documents = [
    (master_doc, 'pylissom.tex', 'pylissom Documentation',
     'Hernan Barijhoff', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'pylissom', 'pylissom Documentation',
     author, 'pylissom', 'One line description of project.',
     'Miscellaneous'),
]
